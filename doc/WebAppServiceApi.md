...
final api = Openapi().getWebAppServiceApi();

try {
    api.getWebConfigurationpage();
} on DioException catch (e) {
    print('Exception when calling WebAppServiceApi->getWebConfigurationpage: $e\n');
}
```
...
> BuiltList<ApiConfigurationPageInfo> getWebConfigurationpages()
...
try {
    final response = api.getWebConfigurationpages();
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebAppServiceApi->getWebConfigurationpages: $e\n');
}
```
...
[**BuiltList&lt;ApiConfigurationPageInfo&gt;**](ApiConfigurationPageInfo.md)
...
try {
    ...
    print('Exception when calling WebAppServiceApi->getWebStrings: $e\n');
}
```
...
# **getWebStringset**
> BuiltList<String> getWebStringset()
...
try {
    final response = api.getWebStringset();
    print(response);
} on DioException catch (e) {
    print('Exception when calling WebAppServiceApi->getWebStringset: $e\n');
}
```
