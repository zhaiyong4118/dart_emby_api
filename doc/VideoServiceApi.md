...
final api = Openapi().getVideoServiceApi();
...
try {
    ...
    print('Exception when calling VideoServiceApi->getVideosByIdByStreamfilename: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VideoServiceApi->getVideosByIdStream: $e\n');
}
```
...
> getVideosByIdStreamByContainer(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, static_, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex)
...
try {
    ...
    print('Exception when calling VideoServiceApi->getVideosByIdStreamByContainer: $e\n');
}
```
...
> headVideosByIdByStreamfilename(streamFileName, id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, static_, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex)
...
try {
    ...
    print('Exception when calling VideoServiceApi->headVideosByIdByStreamfilename: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VideoServiceApi->headVideosByIdStream: $e\n');
}
```
...
> headVideosByIdStreamByContainer(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, static_, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex)
...
try {
    ...
    print('Exception when calling VideoServiceApi->headVideosByIdStreamByContainer: $e\n');
}
```
