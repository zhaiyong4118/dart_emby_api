...
void main() {
  ...
  group(StudiosServiceApi, () {
    ...
    // Requires authentication as user
    //
    //Future<BaseItemDto> getStudiosByName(String name_, { String userId }) async
    test('test getStudiosByName', () async {
      // TODO
    });
