...
void main() {
  ...
  group(PersonsServiceApi, () {
    ...
    // Requires authentication as user
    //
    //Future<BaseItemDto> getPersonsByName(String name_, { String userId }) async
    test('test getPersonsByName', () async {
      // TODO
    });
