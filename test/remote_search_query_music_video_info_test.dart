...
// tests for RemoteSearchQueryMusicVideoInfo
void main() {
  final instance = RemoteSearchQueryMusicVideoInfoBuilder();
  // TODO add properties to the builder and call build()

  group(RemoteSearchQueryMusicVideoInfo, () {
    ...
    test('to test the property `searchProviderName`', () async {
      // TODO
    });
