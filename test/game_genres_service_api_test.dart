...
void main() {
  ...
  group(GameGenresServiceApi, () {
    ...
    // Requires authentication as user
    //
    //Future<BaseItemDto> getGamegenresByName(String name_, { String userId }) async
    test('test getGamegenresByName', () async {
      // TODO
    });
