...
void main() {
  ...
  group(GenresServiceApi, () {
    ...
    // Requires authentication as user
    //
    //Future<BaseItemDto> getGenresByName(String name_, { String userId }) async
    test('test getGenresByName', () async {
      // TODO
    });
