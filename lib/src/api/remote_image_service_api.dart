...
import 'package:openapi/src/model/images_base_download_remote_image.dart';
...
class RemoteImageServiceApi {
  ...
  const RemoteImageServiceApi(this._dio, this._serializers);
  ...
  Future<Response<void>> getImagesRemote({ 
  ...
  /// * [includeAllLanguages] - Optional.
  /// * [enableSeriesImages] - Optional.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RemoteImageResult>> getItemsByIdRemoteimages({ 
    required String id,
    String? type,
    int? startIndex,
    int? limit,
    ...
    final _path = r'/Items/{Id}/RemoteImages'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (enableSeriesImages != null) r'EnableSeriesImages': encodeQueryParameter(_serializers, enableSeriesImages, const FullType(bool)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ImageProviderInfo>>> getItemsByIdRemoteimagesProviders({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/Items/{Id}/RemoteImages/Providers'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ImageProviderInfo)]),
  ...
  /// * [id] - Item Id
  /// * [type] - The image type
  /// * [body] - BaseDownloadRemoteImage: 
  /// * [providerName] - The image provider
  /// * [imageUrl] - The image url
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postItemsByIdRemoteimagesDownload({ 
    required String id,
    required String type,
    required ImagesBaseDownloadRemoteImage body,
    String? providerName,
    String? imageUrl,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/Items/{Id}/RemoteImages/Download'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ImagesBaseDownloadRemoteImage);
