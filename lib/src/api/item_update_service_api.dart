...
class ItemUpdateServiceApi {
  ...
  const ItemUpdateServiceApi(this._dio, this._serializers);
  ...
  Future<Response<MetadataEditorInfo>> getItemsByItemidMetadataeditor({ 
    ...
    final _path = r'/Items/{ItemId}/MetadataEditor'.replaceAll('{' r'ItemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postItemsByItemid({ 
    required String itemId,
