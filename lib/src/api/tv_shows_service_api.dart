...
class TvShowsServiceApi {
  ...
  const TvShowsServiceApi(this._dio, this._serializers);
  ...
  Future<Response<void>> getShowsByIdEpisodes({ 
    required String id,
    int? season,
    String? seasonId,
    String? artistType,
    ...
    final _path = r'/Shows/{Id}/Episodes'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Also see [Gets seasons for a tv series Documentation](https://dev.emby.media/doc/restapi/Item-Information.html)
  Future<Response<QueryResultBaseItemDto>> getShowsByIdSeasons({ 
    required String id,
    String? artistType,
    String? maxOfficialRating,
    bool? hasThemeSong,
    ...
    final _path = r'/Shows/{Id}/Seasons'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getShowsMissing({ 
    String? artistType,
    String? maxOfficialRating,
    bool? hasThemeSong,
    bool? hasThemeVideo,
  ...
  Future<Response<QueryResultBaseItemDto>> getShowsNextup({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getShowsUpcoming({ 
    String? artistType,
    String? maxOfficialRating,
    bool? hasThemeSong,
    bool? hasThemeVideo,
