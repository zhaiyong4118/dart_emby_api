...
import 'package:openapi/src/model/query_result_user_library_official_rating_item.dart';
...
class OfficialRatingServiceApi {
  ...
  const OfficialRatingServiceApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [QueryResultUserLibraryOfficialRatingItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QueryResultUserLibraryOfficialRatingItem>> getOfficialratings({ 
    String? artistType,
    ...
    QueryResultUserLibraryOfficialRatingItem? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(QueryResultUserLibraryOfficialRatingItem),
      ) as QueryResultUserLibraryOfficialRatingItem;
    ...
    return Response<QueryResultUserLibraryOfficialRatingItem>(
      data: _responseData,
