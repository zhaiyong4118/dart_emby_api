...
class ItemsServiceApi {
  ...
  const ItemsServiceApi(this._dio, this._serializers);
  ...
  /// Also see [Gets items based on a query. Documentation](https://dev.emby.media/doc/restapi/Item-Information.html)
  Future<Response<QueryResultBaseItemDto>> getItems({ 
    String? artistType,
  ...
  /// Also see [Gets items based on a query. Documentation](https://dev.emby.media/doc/restapi/Browsing-the-Library.html)
  Future<Response<QueryResultBaseItemDto>> getUsersByUseridItems({ 
    ...
    final _path = r'/Users/{UserId}/Items'.replaceAll('{' r'UserId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// API Documentation: Item Information
  /// Also see [Gets items based on a query. Documentation](https://dev.emby.media/doc/restapi/Item-Information.html)
  Future<Response<QueryResultBaseItemDto>> getUsersByUseridItemsResume({ 
    required String userId,
    String? artistType,
    String? maxOfficialRating,
    bool? hasThemeSong,
    ...
    final _path = r'/Users/{UserId}/Items/Resume'.replaceAll('{' r'UserId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
