...
class VideoServiceApi {
  ...
  const VideoServiceApi(this._dio, this._serializers);
  ...
  Future<Response<void>> getVideosByIdByStreamfilename({ 
    ...
    final _path = r'/Videos/{Id}/{StreamFileName}'.replaceAll('{' r'StreamFileName' '}', encodeQueryParameter(_serializers, streamFileName, const FullType(String)).toString()).replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getVideosByIdStream({ 
    required String id,
    required String container,
    String? deviceProfileId,
    String? deviceId,
    ...
    final _path = r'/Videos/{Id}/stream'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getVideosByIdStreamByContainer({ 
    required String id,
    required String container,
    String? deviceProfileId,
    String? deviceId,
    ...
    final _path = r'/Videos/{Id}/stream.{Container}'.replaceAll('{' r'Id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'Container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> headVideosByIdByStreamfilename({ 
    required String streamFileName,
    required String id,
    required String container,
    String? deviceProfileId,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> headVideosByIdStream({ 
    required String id,
    required String container,
    String? deviceProfileId,
    String? deviceId,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> headVideosByIdStreamByContainer({ 
    required String id,
    required String container,
    String? deviceProfileId,
    String? deviceId,
