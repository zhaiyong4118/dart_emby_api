...
class ArtistsServiceApi {
  ...
  const ArtistsServiceApi(this._dio, this._serializers);
  ...
  /// Also see [Gets all artists from a given item, folder, or the entire library Documentation](https://dev.emby.media/doc/restapi/Items-by-Name.html)
  Future<Response<QueryResultBaseItemDto>> getArtists({ 
    String? artistType,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// API Documentation: Items by name
  /// Also see [Gets all album artists from a given item, folder, or the entire library Documentation](https://dev.emby.media/doc/restapi/Items-by-Name.html)
  Future<Response<QueryResultBaseItemDto>> getArtistsAlbumartists({ 
    String? artistType,
    String? maxOfficialRating,
    bool? hasThemeSong,
    bool? hasThemeVideo,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// API Documentation: Items by name
  /// Also see [Gets an artist, by name Documentation](https://dev.emby.media/doc/restapi/Items-by-Name.html)
  Future<Response<BaseItemDto>> getArtistsByName({ 
    ...
    final _path = r'/Artists/{Name}'.replaceAll('{' r'Name' '}', encodeQueryParameter(_serializers, name_, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
