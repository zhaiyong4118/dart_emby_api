...
class ChannelServiceApi {
  ...
  const ChannelServiceApi(this._dio, this._serializers);
  ...
  /// Also see [Gets available channels Documentation](https://dev.emby.media/doc/restapi/Item-Information.html)
  Future<Response<QueryResultBaseItemDto>> getChannels({ 
    String? artistType,
