...
class StudiosServiceApi {
  ...
  const StudiosServiceApi(this._dio, this._serializers);
  ...
  /// Also see [Gets all studios from a given item, folder, or the entire library Documentation](https://dev.emby.media/doc/restapi/Items-by-Name.html)
  Future<Response<QueryResultBaseItemDto>> getStudios({ 
    String? artistType,
  ...
  /// Throws [DioException] if API call or serialization fails
  /// API Documentation: Items by name
  /// Also see [Gets a studio, by name Documentation](https://dev.emby.media/doc/restapi/Items-by-Name.html)
  Future<Response<BaseItemDto>> getStudiosByName({ 
    ...
    final _path = r'/Studios/{Name}'.replaceAll('{' r'Name' '}', encodeQueryParameter(_serializers, name_, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
