...
class SuggestionsServiceApi {
  ...
  const SuggestionsServiceApi(this._dio, this._serializers);
  ...
  Future<Response<QueryResultBaseItemDto>> getUsersByUseridSuggestions({ 
    ...
    final _path = r'/Users/{UserId}/Suggestions'.replaceAll('{' r'UserId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
