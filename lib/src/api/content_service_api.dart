...
import 'package:openapi/src/model/content_section.dart';
...
class ContentServiceApi {
  ...
  const ContentServiceApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ContentSection>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ContentSection>>> getUsersByUseridHomesections({ 
    ...
    final _path = r'/Users/{UserId}/HomeSections'.replaceAll('{' r'UserId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    ...
    BuiltList<ContentSection>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ContentSection)]),
      ) as BuiltList<ContentSection>;
    ...
    return Response<BuiltList<ContentSection>>(
      data: _responseData,
  ...
  /// Also see [ Documentation](https://dev.emby.media/doc/restapi/Item-Information.html)
  Future<Response<QueryResultBaseItemDto>> getUsersByUseridSectionsBySectionidItems({ 
    ...
    final _path = r'/Users/{UserId}/Sections/{SectionId}/Items'.replaceAll('{' r'SectionId' '}', encodeQueryParameter(_serializers, sectionId, const FullType(String)).toString()).replaceAll('{' r'UserId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
