...
/// * [positionTicks] 
@BuiltValue()
abstract class PlaybackProgressInfo implements Built<PlaybackProgressInfo, PlaybackProgressInfoBuilder> {
  ...
  factory PlaybackProgressInfo([void updates(PlaybackProgressInfoBuilder b)]) = _$PlaybackProgressInfo;
