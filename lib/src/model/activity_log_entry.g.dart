...
class _$ActivityLogEntry extends ActivityLogEntry {
  ...
  @override
  final LoggingLogSeverity? severity;
...
class ActivityLogEntryBuilder
  ...
  LoggingLogSeverity? _severity;
  LoggingLogSeverity? get severity => _$this._severity;
  set severity(LoggingLogSeverity? severity) => _$this._severity = severity;
