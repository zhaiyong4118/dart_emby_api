...
class UserActionType extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'PlayedItem')
  static const UserActionType playedItem = _$playedItem;
  @BuiltValueEnumConst(wireName: r'MarkPlayed')
  static const UserActionType markPlayed = _$markPlayed;
  @BuiltValueEnumConst(wireName: r'MarkFavorite')
  static const UserActionType markFavorite = _$markFavorite;
