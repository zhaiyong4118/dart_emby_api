...
class _$SeriesInfo extends SeriesInfo {
  @override
  final DateTime? episodeAirDate;
  @override
  final SeriesDisplayOrder? displayOrder;
  @override
  final String? name_;
  @override
  final String? path;
  ...
  bool operator ==(Object other) {
    ...
    return other is SeriesInfo &&
        episodeAirDate == other.episodeAirDate &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, episodeAirDate.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'SeriesInfo')
          ..add('episodeAirDate', episodeAirDate)
...
class SeriesInfoBuilder implements Builder<SeriesInfo, SeriesInfoBuilder> {
  _$SeriesInfo? _$v;

  DateTime? _episodeAirDate;
  DateTime? get episodeAirDate => _$this._episodeAirDate;
  set episodeAirDate(DateTime? episodeAirDate) =>
      _$this._episodeAirDate = episodeAirDate;

  SeriesDisplayOrder? _displayOrder;
  SeriesDisplayOrder? get displayOrder => _$this._displayOrder;
  set displayOrder(SeriesDisplayOrder? displayOrder) =>
  ...
  SeriesInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _episodeAirDate = $v.episodeAirDate;
