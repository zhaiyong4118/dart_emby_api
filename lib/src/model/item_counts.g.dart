...
class _$ItemCounts extends ItemCounts {
  ...
  bool operator ==(Object other) {
    ...
    return other is ItemCounts &&
        ...
        gameSystemCount == other.gameSystemCount &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, gameCount.hashCode);
    _$hash = $jc(_$hash, artistCount.hashCode);
    _$hash = $jc(_$hash, programCount.hashCode);
    _$hash = $jc(_$hash, gameSystemCount.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'ItemCounts')
          ...
          ..add('gameCount', gameCount)
          ..add('artistCount', artistCount)
          ..add('programCount', programCount)
          ..add('gameSystemCount', gameSystemCount)
...
class ItemCountsBuilder implements Builder<ItemCounts, ItemCountsBuilder> {
  ...
  int? _gameCount;
  int? get gameCount => _$this._gameCount;
  set gameCount(int? gameCount) => _$this._gameCount = gameCount;
  ...
  int? _gameSystemCount;
  int? get gameSystemCount => _$this._gameSystemCount;
  set gameSystemCount(int? gameSystemCount) =>
      _$this._gameSystemCount = gameSystemCount;
  ...
  ItemCountsBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _gameCount = $v.gameCount;
      _artistCount = $v.artistCount;
      _programCount = $v.programCount;
      _gameSystemCount = $v.gameSystemCount;
