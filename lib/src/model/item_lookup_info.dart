...
/// * [enableAdultMetadata] 
@BuiltValue()
abstract class ItemLookupInfo implements Built<ItemLookupInfo, ItemLookupInfoBuilder> {
  ...
  factory ItemLookupInfo([void updates(ItemLookupInfoBuilder b)]) = _$ItemLookupInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ItemLookupInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ItemLookupInfo> get serializer => _$ItemLookupInfoSerializer();
}

class _$ItemLookupInfoSerializer implements PrimitiveSerializer<ItemLookupInfo> {
  @override
  final Iterable<Type> types = const [ItemLookupInfo, _$ItemLookupInfo];

  @override
  final String wireName = r'ItemLookupInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ItemLookupInfo object, {
  ...
  void _deserializeProperties(
    ...
    required ItemLookupInfoBuilder result,
  ...
  @override
  ItemLookupInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ItemLookupInfoBuilder();
