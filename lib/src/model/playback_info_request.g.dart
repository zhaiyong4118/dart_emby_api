...
part of 'playback_info_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PlaybackInfoRequest extends PlaybackInfoRequest {
  @override
  final String? id;
  @override
  final String? userId;
  ...
  @override
  final String? currentPlaySessionId;

  factory _$PlaybackInfoRequest(
          [void Function(PlaybackInfoRequestBuilder)? updates]) =>
      (PlaybackInfoRequestBuilder()..update(updates))._build();

  _$PlaybackInfoRequest._(
      {this.id,
      this.userId,
      ...
      : super._();
  @override
  PlaybackInfoRequest rebuild(
          void Function(PlaybackInfoRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PlaybackInfoRequestBuilder toBuilder() =>
      PlaybackInfoRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PlaybackInfoRequest &&
        id == other.id &&
        userId == other.userId &&
        ...
        isPlayback == other.isPlayback &&
        autoOpenLiveStream == other.autoOpenLiveStream &&
        currentPlaySessionId == other.currentPlaySessionId;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, isPlayback.hashCode);
    _$hash = $jc(_$hash, autoOpenLiveStream.hashCode);
    _$hash = $jc(_$hash, currentPlaySessionId.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PlaybackInfoRequest')
          ..add('id', id)
          ..add('userId', userId)
          ...
          ..add('isPlayback', isPlayback)
          ..add('autoOpenLiveStream', autoOpenLiveStream)
          ..add('currentPlaySessionId', currentPlaySessionId))
        .toString();
  }
}

class PlaybackInfoRequestBuilder
    implements Builder<PlaybackInfoRequest, PlaybackInfoRequestBuilder> {
  _$PlaybackInfoRequest? _$v;
  ...
  bool? _isPlayback;
  bool? get isPlayback => _$this._isPlayback;
  set isPlayback(bool? isPlayback) => _$this._isPlayback = isPlayback;
  ...
  String? get currentPlaySessionId => _$this._currentPlaySessionId;
  set currentPlaySessionId(String? currentPlaySessionId) =>
      _$this._currentPlaySessionId = currentPlaySessionId;

  PlaybackInfoRequestBuilder() {
    PlaybackInfoRequest._defaults(this);
  }

  PlaybackInfoRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _userId = $v.userId;
      ...
      _isPlayback = $v.isPlayback;
      _autoOpenLiveStream = $v.autoOpenLiveStream;
      _currentPlaySessionId = $v.currentPlaySessionId;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(PlaybackInfoRequest other) {
    _$v = other as _$PlaybackInfoRequest;
  }

  @override
  void update(void Function(PlaybackInfoRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PlaybackInfoRequest build() => _build();

  _$PlaybackInfoRequest _build() {
    _$PlaybackInfoRequest _$result;
    try {
      _$result = _$v ??
          _$PlaybackInfoRequest._(
            id: id,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'PlaybackInfoRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
