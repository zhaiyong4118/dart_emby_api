...
part of 'item_lookup_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ItemLookupInfo extends ItemLookupInfo {
  @override
  final String? name_;
  @override
  final String? path;
  ...
  factory _$ItemLookupInfo([void Function(ItemLookupInfoBuilder)? updates]) =>
      (ItemLookupInfoBuilder()..update(updates))._build();
  ...
  _$ItemLookupInfo._(
      ...
      : super._();
  @override
  ItemLookupInfo rebuild(void Function(ItemLookupInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ItemLookupInfoBuilder toBuilder() => ItemLookupInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ItemLookupInfo &&
        name_ == other.name_ &&
        path == other.path &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ItemLookupInfo')
          ..add('name_', name_)
          ..add('path', path)
...
class ItemLookupInfoBuilder
    implements Builder<ItemLookupInfo, ItemLookupInfoBuilder> {
  _$ItemLookupInfo? _$v;
  ...
  ItemLookupInfoBuilder() {
    ItemLookupInfo._defaults(this);
  }

  ItemLookupInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name_ = $v.name_;
      _path = $v.path;
  ...
  @override
  void replace(ItemLookupInfo other) {
    _$v = other as _$ItemLookupInfo;
  }

  @override
  void update(void Function(ItemLookupInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ItemLookupInfo build() => _build();

  _$ItemLookupInfo _build() {
    _$ItemLookupInfo _$result;
    try {
      _$result = _$v ??
          _$ItemLookupInfo._(
            name_: name_,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'ItemLookupInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
