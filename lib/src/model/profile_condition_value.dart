...
class ProfileConditionValue extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'VideoRange')
  static const ProfileConditionValue videoRange = _$videoRange;
  @BuiltValueEnumConst(wireName: r'VideoRotation')
  static const ProfileConditionValue videoRotation = _$videoRotation;
  @BuiltValueEnumConst(wireName: r'IsExternalAudio')
  static const ProfileConditionValue isExternalAudio = _$isExternalAudio;
