...
part of 'live_tv_listings_provider_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LiveTvListingsProviderInfo extends LiveTvListingsProviderInfo {
  @override
  final String? name_;
  @override
  ...
  factory _$LiveTvListingsProviderInfo(
          [void Function(LiveTvListingsProviderInfoBuilder)? updates]) =>
      (LiveTvListingsProviderInfoBuilder()..update(updates))._build();

  _$LiveTvListingsProviderInfo._(
      {this.name_,
      this.setupUrl,
      this.id,
      this.type,
      ...
      : super._();
  @override
  LiveTvListingsProviderInfo rebuild(
          void Function(LiveTvListingsProviderInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LiveTvListingsProviderInfoBuilder toBuilder() =>
      LiveTvListingsProviderInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LiveTvListingsProviderInfo &&
        name_ == other.name_ &&
        ...
        tvgShiftTicks == other.tvgShiftTicks &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LiveTvListingsProviderInfo')
          ..add('name_', name_)
          ...
          ..add('tvgShiftTicks', tvgShiftTicks)
...
class LiveTvListingsProviderInfoBuilder
    implements
        Builder<LiveTvListingsProviderInfo, LiveTvListingsProviderInfoBuilder> {
  _$LiveTvListingsProviderInfo? _$v;
  ...
  int? _tvgShiftTicks;
  int? get tvgShiftTicks => _$this._tvgShiftTicks;
  set tvgShiftTicks(int? tvgShiftTicks) =>
      _$this._tvgShiftTicks = tvgShiftTicks;
  ...
  String? _dataVersion;
  String? get dataVersion => _$this._dataVersion;
  set dataVersion(String? dataVersion) => _$this._dataVersion = dataVersion;

  LiveTvListingsProviderInfoBuilder() {
    LiveTvListingsProviderInfo._defaults(this);
  }

  LiveTvListingsProviderInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name_ = $v.name_;
  ...
  @override
  void replace(LiveTvListingsProviderInfo other) {
    _$v = other as _$LiveTvListingsProviderInfo;
  }

  @override
  void update(void Function(LiveTvListingsProviderInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  LiveTvListingsProviderInfo build() => _build();

  _$LiveTvListingsProviderInfo _build() {
    _$LiveTvListingsProviderInfo _$result;
    try {
      _$result = _$v ??
          _$LiveTvListingsProviderInfo._(
            name_: name_,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'LiveTvListingsProviderInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
