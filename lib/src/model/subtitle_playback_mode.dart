...
class SubtitlePlaybackMode extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'HearingImpaired')
  static const SubtitlePlaybackMode hearingImpaired = _$hearingImpaired;

  static Serializer<SubtitlePlaybackMode> get serializer => _$subtitlePlaybackModeSerializer;
...
abstract class SubtitlePlaybackModeMixin = Object with _$SubtitlePlaybackModeMixin;
