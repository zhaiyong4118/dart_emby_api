...
part of 'remote_search_query_book_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RemoteSearchQueryBookInfo extends RemoteSearchQueryBookInfo {
  @override
  ...
  factory _$RemoteSearchQueryBookInfo(
          [void Function(RemoteSearchQueryBookInfoBuilder)? updates]) =>
      (RemoteSearchQueryBookInfoBuilder()..update(updates))._build();

  _$RemoteSearchQueryBookInfo._(
      {this.searchInfo,
      this.itemId,
      ...
      : super._();
  @override
  RemoteSearchQueryBookInfo rebuild(
          void Function(RemoteSearchQueryBookInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RemoteSearchQueryBookInfoBuilder toBuilder() =>
      RemoteSearchQueryBookInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RemoteSearchQueryBookInfo &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RemoteSearchQueryBookInfo')
...
class RemoteSearchQueryBookInfoBuilder
    implements
        Builder<RemoteSearchQueryBookInfo, RemoteSearchQueryBookInfoBuilder> {
  _$RemoteSearchQueryBookInfo? _$v;
  ...
  RemoteSearchQueryBookInfoBuilder() {
    RemoteSearchQueryBookInfo._defaults(this);
  }

  RemoteSearchQueryBookInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(RemoteSearchQueryBookInfo other) {
    _$v = other as _$RemoteSearchQueryBookInfo;
  }

  @override
  void update(void Function(RemoteSearchQueryBookInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RemoteSearchQueryBookInfo build() => _build();

  _$RemoteSearchQueryBookInfo _build() {
    _$RemoteSearchQueryBookInfo _$result;
    try {
      _$result = _$v ??
          _$RemoteSearchQueryBookInfo._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RemoteSearchQueryBookInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
