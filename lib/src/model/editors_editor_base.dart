...
part 'editors_editor_base.g.dart';
...
/// * [parentId] 
@BuiltValue()
abstract class EditorsEditorBase implements Built<EditorsEditorBase, EditorsEditorBaseBuilder> {
  ...
  factory EditorsEditorBase([void updates(EditorsEditorBaseBuilder b)]) = _$EditorsEditorBase;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EditorsEditorBaseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<EditorsEditorBase> get serializer => _$EditorsEditorBaseSerializer();
}

class _$EditorsEditorBaseSerializer implements PrimitiveSerializer<EditorsEditorBase> {
  @override
  final Iterable<Type> types = const [EditorsEditorBase, _$EditorsEditorBase];

  @override
  final String wireName = r'EditorsEditorBase';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EditorsEditorBase object, {
  ...
  void _deserializeProperties(
    ...
    required EditorsEditorBaseBuilder result,
  ...
  @override
  EditorsEditorBase deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EditorsEditorBaseBuilder();
