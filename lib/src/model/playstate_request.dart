...
abstract class PlaystateRequest implements Built<PlaystateRequest, PlaystateRequestBuilder> {
  ...
  // enum commandEnum {  Stop,  Pause,  Unpause,  NextTrack,  PreviousTrack,  Seek,  Rewind,  FastForward,  PlayPause,  SeekRelative,  };
      ...
      switch (key) {
        case r'Command':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(PlaystateCommand),
          ) as PlaystateCommand?;
