...
class _$GameInfo extends GameInfo {
  @override
  final String? name_;
  @override
  final String? path;
  ...
  factory _$GameInfo([void Function(GameInfoBuilder)? updates]) =>
      (GameInfoBuilder()..update(updates))._build();
  ...
  _$GameInfo._(
      ...
      : super._();
  @override
  GameInfo rebuild(void Function(GameInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GameInfoBuilder toBuilder() => GameInfoBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GameInfo')
          ..add('name_', name_)
          ..add('path', path)
...
class GameInfoBuilder implements Builder<GameInfo, GameInfoBuilder> {
  _$GameInfo? _$v;
  ...
  GameInfoBuilder() {
    GameInfo._defaults(this);
  }

  GameInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name_ = $v.name_;
      _path = $v.path;
  ...
  @override
  void replace(GameInfo other) {
    _$v = other as _$GameInfo;
  }

  @override
  void update(void Function(GameInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GameInfo build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'GameInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
