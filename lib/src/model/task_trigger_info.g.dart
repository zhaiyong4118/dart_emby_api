...
class _$TaskTriggerInfo extends TaskTriggerInfo {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, systemEvent.hashCode);
...
class TaskTriggerInfoBuilder
  ...
  SystemEvent? get systemEvent => _$this._systemEvent;
  set systemEvent(SystemEvent? systemEvent) =>
      _$this._systemEvent = systemEvent;
