...
/// * [enableAdultMetadata] 
@BuiltValue()
abstract class GameInfo implements Built<GameInfo, GameInfoBuilder> {
  ...
  factory GameInfo([void updates(GameInfoBuilder b)]) = _$GameInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GameInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GameInfo> get serializer => _$GameInfoSerializer();
}

class _$GameInfoSerializer implements PrimitiveSerializer<GameInfo> {
  @override
  final Iterable<Type> types = const [GameInfo, _$GameInfo];

  @override
  final String wireName = r'GameInfo';
  ...
  void _deserializeProperties(
    ...
    required GameInfoBuilder result,
  ...
  @override
  GameInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GameInfoBuilder();
