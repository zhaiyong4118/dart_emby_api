...
part of 'remote_search_query_trailer_info.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RemoteSearchQueryTrailerInfo extends RemoteSearchQueryTrailerInfo {
  @override
  ...
  factory _$RemoteSearchQueryTrailerInfo(
          [void Function(RemoteSearchQueryTrailerInfoBuilder)? updates]) =>
      (RemoteSearchQueryTrailerInfoBuilder()..update(updates))._build();

  _$RemoteSearchQueryTrailerInfo._(
      {this.searchInfo,
      this.itemId,
      ...
      : super._();
  @override
  RemoteSearchQueryTrailerInfo rebuild(
          void Function(RemoteSearchQueryTrailerInfoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RemoteSearchQueryTrailerInfoBuilder toBuilder() =>
      RemoteSearchQueryTrailerInfoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RemoteSearchQueryTrailerInfo &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RemoteSearchQueryTrailerInfo')
...
class RemoteSearchQueryTrailerInfoBuilder
    implements
        Builder<RemoteSearchQueryTrailerInfo,
            RemoteSearchQueryTrailerInfoBuilder> {
  _$RemoteSearchQueryTrailerInfo? _$v;
  ...
  RemoteSearchQueryTrailerInfoBuilder() {
    RemoteSearchQueryTrailerInfo._defaults(this);
  }

  RemoteSearchQueryTrailerInfoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(RemoteSearchQueryTrailerInfo other) {
    _$v = other as _$RemoteSearchQueryTrailerInfo;
  }

  @override
  void update(void Function(RemoteSearchQueryTrailerInfoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RemoteSearchQueryTrailerInfo build() => _build();

  _$RemoteSearchQueryTrailerInfo _build() {
    _$RemoteSearchQueryTrailerInfo _$result;
    try {
      _$result = _$v ??
          _$RemoteSearchQueryTrailerInfo._(
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'RemoteSearchQueryTrailerInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
